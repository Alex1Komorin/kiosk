...
const GridPage = () => {
  ...
  const cards = [
    { id: 1, image: '/images/homeIcons/расписание.svg', title: 'Расписание', link: '/games/schedule', external: false, gradient: 'linear-gradient(135deg, var(--color-green) 0%, var(--color-primary-blue) 100%)' },
    ...
    { id: 7, image: '/images/homeIcons/навигация.svg', title: 'Навигация', link: '/games/virtual-tour', external: false, gradient: 'linear-gradient(135deg, var(--color-purple) 0%, var(--color-primary-blue) 100%)' },
  ];
